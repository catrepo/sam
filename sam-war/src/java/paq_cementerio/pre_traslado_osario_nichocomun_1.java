...
public class pre_traslado_osario_nichocomun_1 extends Pantalla {
    ...
    public pre_traslado_osario_nichocomun_1() {
...
//        aut_busca.setMetodoChange("buscarPersona");
        ...
        setSolicitud.setSeleccionTabla("SELECT  B.IDE_FALLECIDO,DETALLE_LUGAR+'-'+SECTOR+'-'+convert(varchar,NUMERO)+'-'+convert(varchar,MODULO) AS CATASTRO,\n"
                + " CEDULA_FALLECIDO,NOMBRES , FECHA_DEFUNCION,FECHA_INGRESA,observacion\n"
                ...
                + "          and DETALLE_LUGAR='OSARIO' ", "IDE_FALLECIDO");
        ...
        setSolicitud.getTab_seleccion().getColumna("NOMBRES").setLongitud(70);
        setSolicitud.getTab_seleccion().getColumna("FECHA_DEFUNCION").setLongitud(30);
        setSolicitud.getTab_seleccion().getColumna("CEDULA_FALLECIDO").setNombreVisual("CEDULA");
        setSolicitud.getTab_seleccion().getColumna("NOMBRES").setNombreVisual("FALLECIDO");
        setSolicitud.getTab_seleccion().getColumna("FECHA_INGRESA").setNombreVisual("FECHA EXUMACION");
        setSolicitud.getTab_seleccion().getColumna("FECHA_INGRESA").setLongitud(30);
        ...
        setSolicitud.setHeader("BUSCAR FALLECIDOS EXHUMADOS POR MORA ");
    ...
    public void dibujarPantalla() {
        ...
        tab_tabla4.getColumna("IDE_CATASTRO").setNombreVisual("NICHO COMUN");
        tab_tabla4.getColumna("IDE_CMREP").setVisible(false);
        tab_tabla4.getColumna("IDE_TIPO_MOVIMIENTO").setVisible(false);
        tab_tabla4.getColumna("IDE_TIPO_MOVIMIENTO").setValorDefecto("11");
