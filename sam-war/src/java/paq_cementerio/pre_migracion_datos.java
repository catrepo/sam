 ...
 * @author Diego
 */
public class pre_migracion_datos extends Pantalla {
    ...
    public pre_migracion_datos() {        //         Imagen de encabezado
...
//        griSear.getChildren().add(griDate);
    ...
    public void dibujarPantalla() {
        ...
        tab_tabla.setTabla("CMT_MIGRACION_DATOS", "cod_tabla", 1);
        if (autBusca.getValue() == null) {
            tab_tabla.setCondicion("cod_tabla=-1");
        } else {
            tab_tabla.setCondicion("cod_tabla in (" + autBusca.getValor() + ")");
        }
...
//        tab_tabla.getColumna("ren_cedula").setNombreVisual("CEDULA");
        ...
        tab_tabla.getColumna("ren_cedula").setLongitud(20);
        tab_tabla.getColumna("ren_nombres").setLongitud(50);
        tab_tabla.getColumna("ren_lugar").setLongitud(15);
        tab_tabla.getColumna("ren_bloque").setLongitud(10);
        tab_tabla.getColumna("ren_FILA").setLongitud(10);
        tab_tabla.getColumna("ren_NUMERO").setLongitud(10);
        ...
        tab_tabla.getColumna("ex_NUMERO").setLectura(true);
        tab_tabla.getColumna("ex_fecha_defuncion").setLectura(true);
