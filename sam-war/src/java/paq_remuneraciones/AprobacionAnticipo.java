 ...
 * @author p-chumana
 */
public class AprobacionAnticipo extends Pantalla {
...
//        bar_botones.agregarBoton(botPago);
        ...
        tabAnticipo.getColumna("mes_sig").setVisible(false);
                    ...
                    if (tabAnticipo.getValor(i, "id_distributivo").equals("NL")) {//detalle solicitud de empleados
                        if (tabAnticipo.getValor(i, "cuota_adicional") != null && !tabAnticipo.getValor(i, "cuota_adicional").isEmpty()) {
                            for (int j = 1; j < (Integer.parseInt(tabAnticipo.getValor(i, "cuotas"))); j++) {
                                ...
                                Integer id;
//                                if (utilitario.getDia(utilitario.getFechaActual()) <= maxDiaDesc(String.valueOf(utilitario.getDia(utilitario.getFechaActual())), tabAnticipo.getValor(i, "id_distributivo"))) {
...
//    public int maxDiaDesc(String dia, String tipo) {
//        DiaMax = 0;
//        try {
//            TablaGenerica tabValidar = adminRemuneracion.getVerificaCondicion1("FCD", tipo, dia);
//            if (!tabValidar.isEmpty()) {
//                DiaMax = Integer.parseInt(tabValidar.getValor("parametro1"));
//            } else {
//                DiaMax = 0;
//            }
//        } catch (Exception e) {
