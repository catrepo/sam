...
public class DocumentoDeclaraciones extends Pantalla {
    ...
    private Tabla setVerificacion = new Tabla();
    ...
    public DocumentoDeclaraciones() {
        ...
        Boton botVerificacion = new Boton();
        botVerificacion.setValue("Verif. Información");
        botVerificacion.setIcon("ui-icon-person");
        botVerificacion.setMetodo("verifInformacion");
        bar_botones.agregarBoton(botVerificacion);
        ...
        tabEmpleado.getColumna(" dir_ordenador_gasto").setVisible(false);
        ...
        tabTabla.getColumna("doc_documento").setUpload("declaraciones");
        ...
        diaDialogov.setTitle("REPORTE"); //titulo
        diaDialogov.setWidth("65%"); //siempre en porcentajes  ancho
        diaDialogov.setHeight("55%");//siempre porcentaje   alto 
        ...
        diaDialogo.setWidth("62%"); //siempre en porcentajes  ancho
        ...
        setVerificacion.setId("setVerificacion");
        setVerificacion.setConexion(conPostgres);
        setVerificacion.setSql("select e.cod_empleado,e.cedula_pass,e.nombres,\n"
                + "d.doc_fecha_declaracion,\n"
                + "d.doc_tipo_declaracion,\n"
                + "(select nombre_registro from srh_notarias_abogados where cod_notaria = cast(d.doc_notaria as integer)) as notaria ,\n"
                + "(select nombre_registro from srh_notarias_abogados where cod_notaria = cast(d.doc_abogado as integer))as abogado,\n"
                + "d.doc_documento \n"
                + "from srh_empleado e\n"
                + "inner join srh_documentos_declaraciones d on e.cod_empleado=d.cod_empleado\n"
                + "order by nombres");
        setVerificacion.getColumna("nombres").setFiltro(true);
        setVerificacion.getColumna("notaria").setFiltro(true);
        setVerificacion.getColumna("notaria").setLongitud(40);
        setVerificacion.getColumna("abogado").setLongitud(40);
        setVerificacion.getColumna("nombres").setLongitud(40);
        setVerificacion.getColumna("doc_documento").setLongitud(40);
        setVerificacion.setTipoSeleccion(false);
        setVerificacion.setRows(10);
        setVerificacion.dibujar();

    }

    public void verifInformacion() {
        diaDialogov.Limpiar();
        diaDialogov.setDialogo(gridv);
        gridv.getChildren().add(setVerificacion);
        diaDialogov.setDialogo(gridV);
        setVerificacion.dibujar();
        diaDialogov.dibujar();
    }
    ...
    public Tabla getSetVerificacion() {
        return setVerificacion;
    }

    public void setSetVerificacion(Tabla setVerificacion) {
        this.setVerificacion = setVerificacion;
    }
