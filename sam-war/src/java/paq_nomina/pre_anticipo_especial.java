    ...
    public void llenarDatosE() {//SOLICITANTE
        ...
        if (!tab_dato.isEmpty()) {
            ...
            if (utilitario.getMes(utilitario.getFechaActual()) != 1) {
                ...
                if (utilitario.getDia(tab_parametros.getValor("FECHA_ANTICIPO")) <= 25) {
            ...
            if (utilitario.validarCedula(tab_anticipo.getValor("ci_solicitante"))) {
                ...
                if (!tab_dato1.isEmpty()) {
                    Double rmu = Double.valueOf(tab_dato1.getValor("total"));
                    if (rmu > 1) {
                        ...
                        tab_anticipo.setValor("rmu_liquido_anterior", tab_dato1.getValor("total"));
                        ...
                        utilitario.agregarNotificacionInfo("SU REMUNERACION ANTERIOR NO LE PERMITE REALIZAR ANTICIPO", tab_dato1.getValor("total"));
                    }
                } else {
                    TablaGenerica tab_dato2 = iAnticipos.empleadosCed(tab_anticipo.getValor("ci_solicitante"), anio, mes);//trabajadores
                    if (!tab_dato2.isEmpty()) {
                        Double rmut = Double.valueOf(tab_dato2.getValor("total"));
                        if (rmut > 1) {
                            ...
                            tab_anticipo.setValor("rmu", tab_dato2.getValor("ru"));
                            tab_anticipo.setValor("rmu_liquido_anterior", tab_dato2.getValor("total"));
                            ...
                            utilitario.agregarNotificacionInfo("SU REMUNERACION ANTERIOR NO LE PERMITE REALIZAR ANTICIPO", tab_dato2.getValor("total"));
                        }
                    } else {
                    ...
                    if (!tab_dato.isEmpty()) {
                        ...
                        if (mes.equals("1")) {//mes de enero
                            ...
                            if (!tab_dato2.isEmpty()) {
                                ...
                                utilitario.agregarMensajeInfo("No existen Datos1", "");
                            }
                        }
                    } else {
                        utilitario.agregarMensajeInfo("No existen Datos2", "");
                    }
                }
                    ...
                    if (!tab_dato.isEmpty()) {
                        ...
                        if (mes.equals("2")) {//para febrero
                            ...
                            if (!tab_dato1.isEmpty()) {
                                ...
                                utilitario.agregarMensajeInfo("No existen Datos3", "");
                            }
                            ...
                            if (cuota == 11) {
                                ...
                                if (!tab_datoa.isEmpty()) {
                                    ...
                                    utilitario.agregarMensajeInfo("No existen Datos4", "");
                                }
                            } else {
                                TablaGenerica tab_dato1 = iAnticipos.periodos(meses(Integer.parseInt(tab_parametros.getValor("numero_cuotas_anticipo")) + mess - 1), String.valueOf(Integer.parseInt(anio)));
                                if (!tab_dato1.isEmpty()) {
                                    ...
                                    utilitario.agregarMensajeInfo("No existen Datos5", "");
                                }
                            }
                            ...
                            if (cuota == 11 || cuota == 10) {
                                ...
                                if (!tab_datoa.isEmpty()) {
                                    ...
                                    utilitario.agregarMensajeInfo("No existen Datos6", "");
                                }
                            } else {
                                TablaGenerica tab_dato1 = iAnticipos.periodos(meses(Integer.parseInt(tab_parametros.getValor("numero_cuotas_anticipo")) + mess - 1), String.valueOf(Integer.parseInt(anio)));
                                if (!tab_dato1.isEmpty()) {
                                    ...
                                    utilitario.agregarMensajeInfo("No existen Datos7", "");
                                }
                            }
                            ...
                            if (cuota == 11 || cuota == 10 || cuota == 9) {
                                ...
                                if (!tab_datoa.isEmpty()) {
                                    ...
                                    utilitario.agregarMensajeInfo("No existen Datos8", "");
                                }
                            } else {
                                TablaGenerica tab_dato1 = iAnticipos.periodos(meses(Integer.parseInt(tab_parametros.getValor("numero_cuotas_anticipo")) + mess - 1), String.valueOf(Integer.parseInt(anio)));
                                if (!tab_dato1.isEmpty()) {
                                    ...
                                    utilitario.agregarMensajeInfo("No existen Datos9", "");
                                }
                            }
                            ...
                            if (cuota == 11 || cuota == 10 || cuota == 9 || cuota == 8) {
                                ...
                                if (!tab_datoa.isEmpty()) {
                                    ...
                                    utilitario.agregarMensajeInfo("No existen Datos10", "");
                                }
                            } else {
                                TablaGenerica tab_dato1 = iAnticipos.periodos(meses(Integer.parseInt(tab_parametros.getValor("numero_cuotas_anticipo")) + mess - 1), String.valueOf(Integer.parseInt(anio)));
                                if (!tab_dato1.isEmpty()) {
                                    ...
                                    utilitario.agregarMensajeInfo("No existen Datos11", "");
                                }
                            }
                            ...
                            if (cuota == 11 || cuota == 10 || cuota == 9 || cuota == 8 || cuota == 7) {
                                ...
                                if (!tab_datoa.isEmpty()) {
                                    ...
                                    utilitario.agregarMensajeInfo("No existen Datos12", "");
                                }
                            } else {
                                TablaGenerica tab_dato1 = iAnticipos.periodos(meses(Integer.parseInt(tab_parametros.getValor("numero_cuotas_anticipo")) + mess - 1), String.valueOf(Integer.parseInt(anio)));
                                if (!tab_dato1.isEmpty()) {
                                    ...
                                    utilitario.agregarMensajeInfo("No existen Datos13", "");
                                }
                            }
                            ...
                            if (cuota == 11 || cuota == 10 || cuota == 9 || cuota == 8 || cuota == 7 || cuota == 6) {
                                ...
                                if (!tab_datoa.isEmpty()) {
                                    ...
                                    utilitario.agregarMensajeInfo("No existen Datos14", "");
                                }
                            } else {
                                TablaGenerica tab_dato1 = iAnticipos.periodos(meses(Integer.parseInt(tab_parametros.getValor("numero_cuotas_anticipo")) + mess - 1), String.valueOf(Integer.parseInt(anio)));
                                if (!tab_dato1.isEmpty()) {
                                    ...
                                    utilitario.agregarMensajeInfo("No existen Datos15", "");
                                }
                            }
                            ...
                            if (cuota == 11 || cuota == 10 || cuota == 9 || cuota == 8 || cuota == 7 || cuota == 6 || cuota == 5) {
                                ...
                                if (!tab_datoa.isEmpty()) {
                                    ...
                                    utilitario.agregarMensajeInfo("No existen Datos16", "");
                                }
                            } else {
                                TablaGenerica tab_dato1 = iAnticipos.periodos(meses(Integer.parseInt(tab_parametros.getValor("numero_cuotas_anticipo")) + mess - 1), String.valueOf(Integer.parseInt(anio)));
                                if (!tab_dato1.isEmpty()) {
                                    ...
                                    utilitario.agregarMensajeInfo("No existen Datos17", "");
                                }
                            }
                            ...
                            if (cuota == 11 || cuota == 10 || cuota == 9 || cuota == 8 || cuota == 7 || cuota == 6 || cuota == 5 || cuota == 4) {
                                ...
                                if (!tab_datoa.isEmpty()) {
                                    ...
                                    utilitario.agregarMensajeInfo("No existen Datos18", "");
                                }
                            } else {
                                TablaGenerica tab_dato1 = iAnticipos.periodos(meses(Integer.parseInt(tab_parametros.getValor("numero_cuotas_anticipo")) + mess - 1), String.valueOf(Integer.parseInt(anio)));
                                if (!tab_dato1.isEmpty()) {
                                    ...
                                    utilitario.agregarMensajeInfo("No existen Datos19", "");
                                }
                            }
                            ...
                            if (cuota == 11 || cuota == 10 || cuota == 9 || cuota == 8 || cuota == 7 || cuota == 6 || cuota == 5 || cuota == 4 || cuota == 3) {
                                ...
                                if (!tab_datoa.isEmpty()) {
                                    ...
                                    utilitario.agregarMensajeInfo("No existen Datos20", "");
                                }
                            } else {
                                TablaGenerica tab_dato1 = iAnticipos.periodos(meses(Integer.parseInt(tab_parametros.getValor("numero_cuotas_anticipo")) + mess - 1), String.valueOf(Integer.parseInt(anio)));
                                if (!tab_dato1.isEmpty()) {
                                    ...
                                    utilitario.agregarMensajeInfo("No existen Datos21", "");
                                }
                            }
                            ...
                            if (cuota == 11 || cuota == 10 || cuota == 9 || cuota == 8 || cuota == 7 || cuota == 6 || cuota == 5 || cuota == 4 || cuota == 1) {
                                ...
                                if (!tab_datoa.isEmpty()) {
                                    ...
                                    utilitario.agregarMensajeInfo("No existen Datos22", "");
                                }
                            } else {
                                TablaGenerica tab_dato1 = iAnticipos.periodos(meses(Integer.parseInt(tab_parametros.getValor("numero_cuotas_anticipo")) + mess - 1), String.valueOf(Integer.parseInt(anio)));
                                if (!tab_dato1.isEmpty()) {
                                    ...
                                    utilitario.agregarMensajeInfo("No existen Datos23", "");
                                }
                            }
                        }
                    } else {
                        utilitario.agregarMensajeInfo("No existen Datos24", "");
                    }
                } else if (calculo1 > 0) {
                    TablaGenerica tab_dato = iAnticipos.periodos(meses(Integer.parseInt(mes)), String.valueOf(Integer.parseInt(anio)));
                    if (!tab_dato.isEmpty()) {
                        if (Integer.parseInt(tab_anticipo.getValor("ide_tipo_anticipo")) != 1) {
                            ...
                            if (!tab_dato1.isEmpty()) {
                                ...
                                utilitario.agregarMensajeInfo("No existen Datos25", "");
                            }
                        }
                    } else {
                        utilitario.agregarMensajeInfo("No existen Datos", "");
                    ...
                    if (!tab_dato.isEmpty()) {
                        if (Integer.parseInt(tab_anticipo.getValor("ide_tipo_anticipo")) != 1) {
                            ...
                            if (!tab_dato1.isEmpty()) {
                                ...
                                utilitario.agregarMensajeInfo("No existen Datos26", "");
                            }
                        } else {
                            //fecha inicial
                            fecha = tab_dato.getValor("ide_periodo_anticipo");
                            ...
                            if (!tab_dato1.isEmpty()) {
                                ...
                                utilitario.agregarMensajeInfo("No existen Datos27", "");
                            }
                        }
                    } else {
                        utilitario.agregarMensajeInfo("No existen Datos", "");
                ...
                if (calculo1 < 0) {
                    ...
                    if (!tab_dato.isEmpty()) {
                        ...
                        if (!tab_dato2.isEmpty()) {
                            ...
                            utilitario.agregarMensajeInfo("No existen Datos28", "");
                        }
                    } else {
                        utilitario.agregarMensajeInfo("No existen Datos29", "");
                    }
                }
            } else if (Integer.parseInt(tab_parametros.getValor("numero_cuotas_anticipo")) < 12) {
                Integer cuota = 0;
                ...
                if (calculo1 < 0) {
                    ...
                    if (!tab_dato.isEmpty()) {
                        ...
                        if (!tab_dato1.isEmpty()) {
                            ...
                            utilitario.agregarMensajeInfo("No existen Datos30", "");
                        }
                    } else {
                        utilitario.agregarMensajeInfo("No existen Datos", "");
                    }
                    ...
                    if (!tab_dato.isEmpty()) {
                        ...
                        if (!tab_dato1.isEmpty()) {
                            ...
                            utilitario.agregarMensajeInfo("No existen Datos31", "");
                        }
                    } else {
                        utilitario.agregarMensajeInfo("No existen Datos32", "");
                    }
                } else if (calculo1 == 0) {
                    TablaGenerica tab_dato = iAnticipos.periodos(meses(Integer.parseInt(mes) + 1), String.valueOf(Integer.parseInt(anio)));
                    if (!tab_dato.isEmpty()) {
                        ...
                        if (!tab_dato1.isEmpty()) {
                            ...
                            utilitario.agregarMensajeInfo("No existen Datos33", "");
                        }
                    } else {
                        utilitario.agregarMensajeInfo("No existen Datos34", "");
                    }
                }
            }
        }
