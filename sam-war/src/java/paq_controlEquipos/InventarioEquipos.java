...
public class InventarioEquipos extends Pantalla {
    ...
    public InventarioEquipos() {
        ...
        autBusca.setAutoCompletar("SELECT\n"
                + "dbo.CEI_DESCRIPCION_EQUIPOS.DESC_CODIGO,\n"
                + "dbo.CEI_DESCRIPCION_EQUIPOS.DESC_CODIGO_ACTIVO,\n"
                + "dbo.CEI_DESCRIPCION_EQUIPOS.DESC_TIPO_EQUIPO,\n"
                + "dbo.CEI_DESCRIPCION_EQUIPOS.DESC_SERIE,\n"
                ...
                + "dbo.CEI_ASIGNACION.ASIGNACION_NOMBRE\n"
                + "FROM\n"
                + "dbo.CEI_DESCRIPCION_EQUIPOS\n"
                + "left JOIN dbo.CEI_ASIGNACION ON dbo.CEI_ASIGNACION.DESC_CODIGO = dbo.CEI_DESCRIPCION_EQUIPOS.DESC_CODIGO");
