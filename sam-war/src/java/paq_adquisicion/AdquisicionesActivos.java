...
public class AdquisicionesActivos extends Pantalla {
 ...
 if (tienePerfilSecretaria()) {          
        ...
        bot_aprobar.setValue("APROBAR INEXISTENCIA");
        ...
        bot_anular.setMetodo("aprobarAnulado");        
...
public void aprobarSolicitud(){
    System.out.println("valor del formulario "+tab_adquisiones.getValorSeleccionado());
    if(tab_adquisiones.getValorSeleccionado() != null){
        			con_guardar_aprobado.setMessage("Esta Seguro de No tener en existencias la solicitud "+tab_adquisiones.getValor("NUMERO_ORDEN_ADCOMP"));
