...
public class AdquisicionesDirector extends Pantalla {
 ...
 if (tienePerfilSecretaria()) {          
        ...
        bot_aprobar.setValue("APROBAR LA SOLICITUD");
        ...
        agregarComponente(sel_rep);
            ...
            com_direccion.setCombo(ser_adquisiciones.getAreaAdministrativa("2",ide_ademple));
...
private boolean tienePerfilSecretaria() {
        List sql = utilitario.getConexion().consultar(ser_adquisiciones.getUsuarioSistemaAprobador(utilitario.getVariable("IDE_USUA"), "1",par_aprueba_solicitud));
...
public void aprobarSolicitud(){
    ...
    if(tab_adquisiones.getValorSeleccionado() != null){
        			con_guardar_aprobado.setMessage("Esta Seguro de Aprobar la solicitud "+tab_adquisiones.getValor("NUMERO_ORDEN_ADCOMP"));
...
public void guardarAprobacion(){
    ...
    public void filtroDireccion() {
        ...
        tab_adquisiones.setCondicion("IDE_ADARAD=" + com_direccion.getValue().toString()+" and IDE_ADEMAP="+ide_ademple+" and PRUEBA_DIRECTOR_ADCOMP=0 ");
