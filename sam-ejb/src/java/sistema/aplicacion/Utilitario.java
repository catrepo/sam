...
public class Utilitario extends Framework {
    ...
    public String instalarCertificados() {
        ...
        return Byte.parseByte(i + "");
         ...
         public Date DeStringADateformato3(String fecha) {
        ...
        return convertido;
          ...
          public String DeDateAStringformato2(Date fecha) {
        String convertido = "01-01-1900";
        DateFormat format_fecha = new SimpleDateFormat("dd/mm/yyyy");
        convertido = format_fecha.format(fecha);
        //System.out.println(convertido);
        return convertido;
    }

    public String DeDateAStringformato3(String fecha) {
        String convertido = "01-01-1900";
        DateFormat format_fecha = new SimpleDateFormat("dd/mm/yyyy");
        convertido = format_fecha.format(fecha);
        //System.out.println(convertido);
    ...
    public Date DeStringADateformato2(String fecha) {
     ...
     public Date sumarRestarMesFecha(Date fch, int mes) {
        Calendar cal = new GregorianCalendar();
        cal.setTimeInMillis(fch.getTime());
        cal.add(Calendar.DAY_OF_MONTH, mes);
        return new Date(cal.getTimeInMillis());
    }
    public Date sumarRestarDiasFecha(Date fch, int dias) {
        Calendar cal = new GregorianCalendar();
        cal.setTimeInMillis(fch.getTime());
        cal.add(Calendar.DATE, dias);
        return new Date(cal.getTimeInMillis());
    ...
    public Date sumarRestarAñosFecha(Date fch, int ano) {
        Calendar cal = new GregorianCalendar();
        cal.setTimeInMillis(fch.getTime());
    ...
    public String nuevaFecha(String fecha){
        String anio, mes,dia,fec;
        anio = fecha.substring(0,4);
        mes = fecha.substring(5,7);
        dia = fecha.substring(8,10);
        fec = dia+"-"+mes+"-"+anio;
        System.err.println(""+fec);
        return fec;
    }    
}
