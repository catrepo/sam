...
// Add business logic below. (Right-click in editor and choose
    ...
    public TablaGenerica director() {
        ...
        tabFuncionario.setSql("SELECT e.cod_empleado,\n"
                ...
                + "e.cod_cargo\n"
                + "FROM srh_empleado e\n"
                + "WHERE  e.cedula_pass = '1712432937' AND e.estado = 1");
        tabFuncionario.ejecutarSql();
        desPostgresql();
        return tabFuncionario;
    }
    ...
    public void actuaSolicitud(Integer anti, String cuota, Integer aprob, String usu) {
        String auSql = "update nom_solicitud\n"
                + "set esatdo_solicitud =" + aprob + ",\n"
                + "id_aprobacion ='" + utilitario.getIp() + "',\n"
                + "fecha_aprobacion ='" + utilitario.getFechaActual() + "'\n"
                + "WHERE ide_solicitud_anticipo=" + anti + " and ced_empleado = '" + cuota + "'";
        conPostgresql();
    ...
    public TablaGenerica getSolicitud(Integer ide) {
        ...
        conPostgresql();
        tabFuncionario.setConexion(conPostgres);
        tabFuncionario.setSql("SELECT s.ide_solicitud_anticipo,s.ci_solicitante,s.solicitante,\n"
    ...
    public void setActDetallePagoAnti(Integer ide, String periodo, String anio, String tipo) {
    ...
    public void setActDetallePagoliq(Integer ide, Integer periodo, String tipo) {
        String auSql = "update srh_detalle_anticipo\n"
    ...
    public void setActCalculoPagoAnti(Integer solic, Integer calcu, double valor, String tipo) {
        String auSql = "UPDATE srh_calculo_anticipo \n"
    ...
    public void setActCalculoPagoliq(Integer solic, Integer calcu, String tipo) {
        String auSql = "UPDATE srh_calculo_anticipo\n"
                + "SET ide_estado_anticipo =4,\n"
                + "fecha_pago_anticipado='" + tipo + "' \n"
    ...
    public void setCuotaNueva(Integer solic, Double valor) {
        String auSql = "update srh_detalle_anticipo\n"
                + "set valor = " + valor + "\n"
                + "where ide_detalle_anticipo= " + solic;
        conPostgresql();
        conPostgres.ejecutarSql(auSql);
        desPostgresql();
    }
    ...
    public void setAbonoAnticipos(Integer ide, String cod, String fecha, Double valor, Integer numero, String comentario, String bono) {
        String auSql = "insert into srh_abono_anticipo(ide_solicitud,cod_abono,fecha_abono,valor_abono,numero_documento,comentario_abono,usu_abono)\n"
                + "values (" + ide + ",'" + cod + "','" + fecha + "'," + valor + "," + numero + ",'" + comentario + "','" + bono + "')";
        conPostgresql();
        conPostgres.ejecutarSql(auSql);
        desPostgresql();
    }
    ...
    public TablaGenerica getRecalculo(Integer ide, Double valor) {
        //Busca a una empresa en la tabla maestra_ruc por ruc
        conPostgresql();
        TablaGenerica tabFuncionario = new TablaGenerica();
        tabFuncionario.setConexion(conPostgres);
        tabFuncionario.setSql("select ide_anticipo,cast((saldo/cuotas) as numeric(10,2))as cuota,cuotas from (\n"
                + "select ide_anticipo,(sum(valor)- " + valor + ") as saldo,count(*) as cuotas\n"
                + "from srh_detalle_anticipo \n"
                + "where ide_anticipo=" + ide + " and ide_periodo_descontado is null group by ide_anticipo) as a");
        tabFuncionario.ejecutarSql();
    ...
    public TablaGenerica getFilas(Integer ide) {
        //Busca a una empresa en la tabla maestra_ruc por ruc
        conPostgresql();
        TablaGenerica tabFuncionario = new TablaGenerica();
        tabFuncionario.setConexion(conPostgres);
        tabFuncionario.setSql("select ide_anticipo, ide_detalle_anticipo\n"
                + " from srh_detalle_anticipo  \n"
                + " where ide_anticipo=" + ide + " and ide_periodo_descontado is null ");
        tabFuncionario.ejecutarSql();
        conPostgres.desconectar(true);
        conPostgres = null;
        return tabFuncionario;
